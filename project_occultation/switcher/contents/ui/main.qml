...
import org.gxde.occultation 1.0 as Occultation

// https://techbase.kde.org/Development/Tutorials/KWin/WindowSwitcher
Occultation.Switcher {
    id: tabBox
            ...
            Rectangle {
                ...
                Component {
                    ...
                    Rectangle {
                        ...
                        // The exoskeleton keeps KWin ThumbnailItem's wId contract,
                        // but obtains this frame from libkywc.
                        Occultation.ThumbnailItem {
                            anchors.fill: parent
                            wId: modelWId
                        }
