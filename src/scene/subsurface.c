...
static void subsurface_tree_handle_subsurface_map(struct wl_listener *listener, void *data)
{
    struct ky_scene_subsurface_tree *subsurface_tree =
...
static void subsurface_tree_handle_subsurface_unmap(struct wl_listener *listener, void *data)
{
    struct ky_scene_subsurface_tree *subsurface_tree =
                                              ...
                                              struct wlr_subsurface *subsurface)
{
    ...
    child->parent = parent;
    ky_scene_node_set_enabled(ky_scene_node_from_tree(child->tree), subsurface->mapped);
